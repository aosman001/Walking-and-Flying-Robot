...
#LX16A.initialize("/dev/cu.usbserial-1430", 0.1)
    ...
    # The robot can walk if the walking function isn't locked.
        ...
        try :
            ...
            if walking_direction == 'forward':
                ...
                while True:
                    positions = [
                        (50, 150, 197, 24, 108, 50, 110, 114),  # Step 1
                        (37, 130, 197, 99, 118, 65, 110, 68),   # Step 2
                        (75, 81, 168, 90, 146, 56, 82, 110),     # Step 3
                        (75, 152, 157, 73, 146, 10, 92, 125),   # Step 4
                    ]
        ...
        # In the "backward" direction, motors 5-8 are in the front instead.
                ...
                while True:
                    positions = [
                        (40,143,185,80,122,55,124,50),    # Step 1
                        (50,158,185,34,109,35,124,125),   # Step 2
                        (78,149,157,76,147,0,95,114),        # Step 3
                        (78,103,167,91,147,57,84,97),       # Step 4
                    ]
                    for pos in positions:
                        try:
                            servo1.move(pos[0], int(1000/walking_speed))
...
def walk_prompt():
    """Prompts the user for walking parameters."""
