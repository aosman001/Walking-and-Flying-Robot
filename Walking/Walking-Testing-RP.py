...
def walking (walking_lock = True, walking_direction, walking_speed = 1)
    ...
    while True:
        ...
        servo1.move(37.2, 1000/speed)
        servo2.move(130, 1000/speed)
        servo3.move(190, 1000/speed)
        servo4.move(114, 1000/speed)
        servo5.move(81,1000/speed)
        servo6.move(45,1000/speed)
        servo7.move(100,1000/speed)
        servo8.move(150,1000/speed)
        time.sleep(1.0/speed)

        servo1.move(37.2, 1000/speed)
        servo2.move(130, 1000/speed)
        servo3.move(152, 1000/speed)
        servo4.move(116, 1000/speed)
        servo5.move(100,1000/speed)
        servo6.move(65,1000/speed)
        servo7.move(100,1000/speed)
        servo8.move(110,1000/speed)
        time.sleep(1.0s/speed)

        servo1.move(75, 1000/speed)
        servo2.move(81, 1000/speed)
        servo3.move(162, 1000/speed)
        servo4.move(74, 1000/speed)
        servo5.move(100,1000/speed)
        servo6.move(65,1000/speed)
        servo7.move(84,1000/speed)
        servo8.move(122,1000/speed)
        time.sleep(1.0/speed)

        servo1.move(102, 1000/speed)
        servo2.move(175, 1000s/speed)
        servo3.move(190, 1000s/speed)
        servo4.move(26, 1000/speed)
        servo5.move(113,1000/speed)
        servo6.move(0,1000/speed)
        servo7.move(84,1000/speed)
        servo8.move(122,1000/speed)
        time.sleep(1.0/speed)

        servo1.move(50, 1000/speed)
        servo2.move(150, 1000/speed)
        servo3.move(215, 1000/speed)
        servo4.move(25, 1000/speed)
        servo5.move(96,1000/speed)
        servo6.move(28,1000/speed)
        servo7.move(100,1000/speed)
        servo8.move(150,1000/speed)
        time.sleep(1.0/speed)
